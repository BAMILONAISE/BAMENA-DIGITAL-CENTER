      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="text" className="w-full mt-1 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Prénom" />
          </div>
          <div>
            <label className="block text-sm font-medium">Nom</label>
            <input type="text" className="w-full mt-1 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Nom" />
          </div>
          <div>
            <label className="block text-sm font-medium">Email</label>
            <input type="email" className="w-full mt-1 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="exemple@email.com" />
          </div>
          <div>
            <label className="block text-sm font-medium">Mot de passe</label>
            <input type="password" className="w-full mt-1 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="date" className="w-full mt-1 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500" />
          </div>
          <div>
            <label className="block text-sm font-medium">Quartier à Bamena</label>
            <select
              value={selectedQuarter}
              onChange={handleQuarterChange}
              className="w-full mt-1 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              <option value="">-- Choisissez un quartier --</option>
              <option value="Batsengla">Batsengla</option>
              <option value="Tsinfem">Tsinfem</option>
              <option value="Lefock">Lefock</option>
              <option value="Foumbouh">Foumbouh</option>
              <option value="Kouoptamo">Kouoptamo</option>
              <option value="Koptamo Nord">Koptamo Nord</option>
            ...
            {selectedQuarter === 'autre' && (
              <input
                ...
                className="w-full mt-2 p-3 rounded border border-gray-300 hover:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500"
              />
            )}
          </div>
